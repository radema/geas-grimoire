...
1. **Iterative Interview Loop**: Use the `brainstorming` skill.
   ...
   - **Architectural Preference**: Monolith vs. Microservices?
...
1. **Identify Foundations**: What needs to exist first? (e.g., config setup, data models).
...
Generate a markdown file (e.g., `.bolts/strategy-map.md` or a specific phase roadmap like `.bolts/roadmap-phase2.md`):
